...
Module HelperMethods
    ...
    ''' <summary>Bildgröße in Abhängikeit vom Zeichenodus berechnen.</summary>
    ''' <param name="Mode">Anzeigemodus des Controls.</param>
    ''' <param name="Control">Control dessen Bildgröße berechnet werden soll.</param>
    ''' <param name="Gif">Bild dessen Werte verwendet werden sollen.</param>
    ''' <param name="Zoom">Zoomwert</param>
    Friend Function GetRectStartSize(
    ...
    ''' <summary>Startpunkt der Zeichenfläche in Abhängikeit vom Zeichenodus berechnen.</summary>
    ''' <param name="Mode">Anzeigemodus des Controls.</param>
    ''' <param name="Control">Control dessen Startpunkt berechnet werden soll.</param>
    ''' <param name="Gif">Bild dessen werte verwendet werden sollen.</param>
    ''' <param name="RectStartSize">Startgröße der Zeichenfläche.</param>
    Friend Function GetRectStartPoint(
                                 Mode As SizeMode, Control As AniGif,
